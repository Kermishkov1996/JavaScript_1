class Board {
     ...
     * @param {Food} food будущее расположение еды на поле
     * @param {number} food.x координата x
     * @param {number} food.y координата y
     */
    renderFood(food) {
        const foodCell = this.getCellEl(food.x, food.y);
