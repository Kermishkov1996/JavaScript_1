class Game {
    ...
    /** 
     * Метод получает/передает другие игровые объекты, которые нужны ему
     * для работы.
    ...
    /**
     * Метод дает возможность пойти змейки нажав на стрелки, 
     * назначает обработчики на события клика на кнопку "Пауза",
    ...
    doTick() {
        ...
        /*
        if (this.isGameLostWhenStepToWall()) {
            return;
        }
        */
        //2. проверяет проиграна/выиграна ли игра
