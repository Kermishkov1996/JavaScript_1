let mover = {
    ...
    */
    ...
    /**
    * В зависимости от того, какую стрелку нажал пользователь метод возвращает координаты
    * новой ячуйки, либо если туда нельзя сделать шаг, то координаты существующей ячейки.
    * @param {KeyboardEvent} event объект события нажатия клавиши.
    ...
    * @returns {boolean} если ячейка существует, то true, иначе false.
    */
