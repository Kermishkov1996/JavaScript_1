class Settings {
	...
	* @param {number} params.winLength - какую длину надо наесть, чтобы выйграть
	* @throws {Error} Если переданы неверные настройки, то выбрасывается соотв. ошибка
	*/
	init(params) {
		let defaultParams = {rowsCount: 21, colsCount: 21, speed: 5, winLength: 5};
