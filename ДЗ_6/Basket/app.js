...
basketBtns.forEach(function (btn) {
    btn.addEventListener('click', function (evt) {
        let id = evt.srcElement.dataset.id;
        let price = evt.srcElement.dataset.price;
        let name = evt.srcElement.dataset.name;
